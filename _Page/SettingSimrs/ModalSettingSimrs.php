...
<div class="modal fade" id="ModalResetToken" tabindex="-1">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesResetToken" autocomplete="off">
                <div class="modal-header">
                    <h5 class="modal-title text-dark"><i class="bi bi-repeat"></i> Reset Token</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12" id="FormResetToken">
                            <!-- Form Reset Token Akan Muncul Disini -->
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12" id="NotifikasiResetToken">
                            <!-- Notifikasi Reset Token Akan Muncul Disini -->
                        </div>
                    </div>
                </div>
                <div class="modal-footer">

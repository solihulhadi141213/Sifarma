            ...
            foreach ($entry as $entry_list){
                ...
                echo '
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-1">
                            <a href="javascript:void(0);" class="get_id_practitioner2" data-id="'.$resource['id'].'" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Tempelkan ID Practitioner">

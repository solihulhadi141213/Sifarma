                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-8">
                            <select name="OrderBy" id="OrderBy" class="form-control">
                                ...
                                <option value="nama_satuan_dosis">Nama Satuan</option>
                                <option value="unit_satuan_dosis">Unit Satuan</option>
                                <option value="code_satuan_dosis">Code Satuan</option>
                                <option value="system_satuan_dosis">System</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mb-3">
...
<div class="modal fade" id="ModalExport" tabindex="-1">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="_Page/SatuanDosis/ProsesExport.php" method="GET" target="_blank" autocomplete="off">
                <div class="modal-header">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesTambah" autocomplete="off">
                <div class="modal-header">
                    <h5 class="modal-title text-dark"><i class="bi bi-plus"></i> Tambah Satuan Dosis</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="nama_satuan_dosis">Nama Satuan</label>
                            <input type="text" name="nama_satuan_dosis" id="nama_satuan_dosis" class="form-control" placeholder="">
                            <small><small>Nama satuan dalam bahasa Indonesia (Ex: 'Sendok Makan')</small></small>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="unit_satuan_dosis">Unit Satuan</label>
                            <input type="text" name="unit_satuan_dosis" id="unit_satuan_dosis" class="form-control" placeholder="">
                            <small><small>Unit satuan sesuai FHIR (Ex: 'tablespoon' - untuk 'Sendok Makan')</small></small>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="code_satuan_dosis"><i>Code Unit</i></label>
                            <input type="text" name="code_satuan_dosis" id="code_satuan_dosis" class="form-control" placeholder="">
                            <small><small>Kode satuan sesuai FHIR (Ex: 'tbsp' - Unit Untuk Sendok Makan)</small></small>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="system_satuan_dosis"><i>System</i></label>
                            <input type="url" name="system_satuan_dosis" id="system_satuan_dosis" class="form-control" list="list_system" placeholder="https://">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesEdit" autocomplete="off">
                <div class="modal-header">
                    <h5 class="modal-title text-dark"><i class="bi bi-pencil"></i> Edit Satuan Dosis</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesHapus" autocomplete="off">
                <div class="modal-header">
                    <h5 class="modal-title text-dark"><i class="bi bi-trash"></i> Hapus Satuan Dosis</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">

<?php
    ...
    // Apabila Status Completed Maka Tidak Bisa Dihapus
    if($status_resep=="Completed"){
        echo '
            <div class="alert alert-warning">
                <small>Resep Tidak Bisa Dihapus Karena Sudah Selesai</small>
            </div>
        ';
        exit;
    }
        ...
        <div class="row mb-2">
            <div class="col-12">
                <div class="alert alert-danger text-center">
                    <small>Apakah anda yakin akan menghapus resep tersebut?</small>
                </div>
            </div>
        </div>
    ';

<?php
    ...
    $usia_pasien = hitungUsiaPasien($pasien_tanggal_lahir, $datetime_creat);
?>
<div class="row mb-3">
    <div class="col-12 text-end">
        <button type="button" class="btn btn-md btn-floating btn-dark" id="back_to_tabel" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Kembali Ke Data Peresepan">
            <i class="bi bi-chevron-left"></i>
        </button>
        <button type="button" class="btn btn-md btn-floating btn-outline-primary" id="reload_detail_resep" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Reload Detail Resep">
            <i class="bi bi-repeat"></i>
        </button>
        <button type="button" class="btn btn-md btn-floating btn-primary" id="cetak_lembar_resep" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Cetak Lembar Resep">
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-4 text-end">
                        <button type="button" class="btn btn-md btn-outline-secondary btn-floating modal_update_kunjungan" data-id="<?php echo $id_medication_request_group; ?>" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Update Informasi Kunjungan">
                            <i class="bi bi-arrow-left-right"></i>
                        </button>
                        <button type="button" class="btn btn-md btn-secondary btn-floating modal_edit_resep" data-id="<?php echo $id_medication_request_group; ?>" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit Resep">
                ...
                <?php
                    echo '
                        <div class="row mb-2">
                            ...
                            <div class="col-7"><small class="text text-grayish">'.$id_medication_request_group.'</small></div>
                        </div>
                        <div class="row mb-2">
                        ...
                        <div class="row mb-2">
                            <div class="col-4"><small>ID.REG</small></div>
                            <div class="col-1"><small>:</small></div>
                            <div class="col-7">
                                <a href="javascript:void(0);" class="modal_detail_kunjungan" data-id="'.$id_kunjungan.'">
                                    <small class="text text-primary">'.$id_kunjungan.' <i class="bi bi-arrow-up-right-square"></i></small>
                                </a>
                            </div>
                        </div>
                        <div class="row mb-2">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-1"><small>:</small></div>
                            <div class="col-7"><small class="text text-grayish">'.$priority_name.' - <i>'.$priority.'</i></small></div>
                        </div>
                        <div class="row mb-2">
                        ...
                        <div class="row mb-2">
                            <div class="col-4"><small><i>Gender</i>/Jenis Kelamin</small></div>
                            <div class="col-1"><small>:</small></div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-1"><small>:</small></div>
                            <div class="col-7"><small class="text text-grayish">'.date('d/m/Y', strtotime($pasien_tanggal_lahir)).'</small></div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-4"><small>Usia Pasien</small></div>
                            <div class="col-1"><small>:</small></div>
                            <div class="col-7"><small class="text text-grayish">'.$usia_pasien.' (Saat Resep Dibuat)</small></div>
                        </div>
                        <div class="row mb-2">
    ...
    <div class="col-xl-6 col-lg-12 col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-12">
                        <b class="card-title">B. Item Resep</b>
                    </div>
                </div>
            </div>
            <div class="card-body">

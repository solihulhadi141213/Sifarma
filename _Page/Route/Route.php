<?php
    ...
    $IjinAksesSaya=IjinAksesSaya($Conn,$SessionIdAccess,'ohMdeMk4lZ8y8B9oVokdlCES1O7Q0JmxZXS7');
...
?>
    <div class="pagetitle">
        <h1>
            <a href="">
                <i class="bi bi-collection"></i> Route Obat/Alkes</a>
            </a>
        </h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                <li class="breadcrumb-item active">Route Obat/Alkes</li>
            </ol>
        </nav>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                    <small>
                        Halaman ini digunakan untuk mengelola referensi route Obat / Alkes. Informasi route adalah referensi cara obat / alkes digunakan (dimasukan ke dalam tubuh pasien).

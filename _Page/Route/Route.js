...
function ShowData() {
    ...
    $.ajax({
        type   : 'POST',
        url    : '_Page/Route/TabelRoute.php',
        data   : ProsesFilter,
...
$(document).ready(function() {
    ...
    $('#KeywordBy').change(function(){
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/Route/FormFilter.php',
    ...
    $(document).on('click', '.modal_export', function () {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/Route/FormExport.php',
            success     : function(data){
    ...
    $(document).on('click', '.modal_import', function () {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/Route/FormImport.php',
            success     : function(data){
    ...
    $('#ProsesImport').on('submit', function (e) {
        ...
        $.ajax({
            url: '_Page/Route/ProsesImport.php',
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    $('#ModalTambah').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/Route/list_system.php',
            success     : function(data){
    ...
    $('#ProsesTambah').submit(function(e){
        ...
        $.ajax({
            type     : 'POST',
            url      : '_Page/Route/ProsesTambah.php',
            dataType : 'json',
            data     : ProsesTambah,
    ...
    $(document).on('click', '.modal_edit', function () {
        ...
        var id_referensi_route   = $(this).data('id');
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/Route/FormEdit.php',
            data        : {id_referensi_route: id_referensi_route},
            success     : function(data){
                $('#FormEdit').html(data);
    ...
    $('#ProsesEdit').submit(function(e){
        ...
        $.ajax({
            type     : 'POST',
            url      : '_Page/Route/ProsesEdit.php',
            dataType : 'json',
            data     : ProsesEdit,
    ...
    $('#ProsesHapus').submit(function(e){
        ...
        $.ajax({
            type     : 'POST',
            url      : '_Page/Route/ProsesHapus.php',
            dataType : 'json',
            data     : ProsesHapus,
